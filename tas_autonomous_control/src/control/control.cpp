...
void control::cmdCallback(const geometry_msgs::Twist::ConstPtr& msg)
{
	...
	if(cmd_steeringAngle > 2000 - steering_angle_offset)
	{
		cmd_steeringAngle = 2000 - steering_angle_offset;
	}
	else if(cmd_steeringAngle < 1000 - steering_angle_offset)
	{
		cmd_steeringAngle = 1000 - steering_angle_offset;
	}
}
