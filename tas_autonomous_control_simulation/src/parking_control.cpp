...
//	angle_new_l = einparken->range_array_back[2];
	angle_new_l = lese_winkel( einparken->range_array_back, 2, 5);
	...
	if (fabs(angle_new_l - angle_old_l) > 0.06 && angle_old_l > 1e-4 && angle_new_l > 1e-4 )
	{
...
//ROS_INFO("fang lenken an");
	if (lese_winkel( einparken->range_array_back, 1, 60) > 0.48 && einparken->fortschritt < 1)
	{
ROS_INFO("1. range_array_back[1-80] = %f", lese_winkel( einparken->range_array_back, 1, 80));
...
/*	else if ((fabs(lese_winkel( einparken->range_array_back, 1, 2)-lese_winkel( einparken->range_array_front, 158, 2)) > 0.05 || fabs(lese_winkel( einparken->range_array_back, 78, 2)-lese_winkel( einparken->range_array_front, 80, 2)) > 0.2 ) && einparken->fortschritt <2)*/
	...
	else if ( (einparken->range_array_front[320]/einparken->range_array_front[328] > 0.99 || einparken->range_array_front[320]/einparken->range_array_front[328] < 0.96 || einparken->range_array_front[320]/einparken->range_array_front[336] > 0.99 || einparken->range_array_front[320]/einparken->range_array_front[336] < 0.96) && einparken->fortschritt <2) 
...
ROS_INFO("2. back[30-35]/front[30-35] = %f", fabs(lese_winkel( einparken->range_array_back, 78, 2)-lese_winkel( einparken->range_array_front, 80, 2)));*/
	...
	else if (lese_winkel( einparken->range_array_back, 70, 10) > 0.2 && einparken->fortschritt <3)
	{
...
ROS_INFO("3. range_array_back[300-310] = %f", lese_winkel( einparken->range_array_back, 70, 10) );
	...
	else if (lese_winkel( einparken->range_array_back, 70, 10)/lese_winkel( einparken->range_array_front, 80, 10) < 0.9 && einparken->fortschritt <4)
	{
